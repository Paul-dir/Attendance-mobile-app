            ...
            Button(
                onClick = {
                    ...
                    if (studentName.isNotEmpty() && studentId.isNotEmpty() && batch.isNotEmpty() &&
                        ...
                        studentList.add(
                            Student(studentName, studentId, batch, date, course, teacher)
                        )
                        // Clear form fields
                        studentName = ""
                        studentId = ""
...
fun StudentItem(student: Student) {
    Column(
        ...
        Text(text = "Name: ${student.name}", fontSize = 16.sp)
        Text(text = "ID: ${student.id}", fontSize = 14.sp)
        Text(text = "Batch: ${student.batch}", fontSize = 14.sp)
        Text(text = "Date: ${student.date}", fontSize = 14.sp)
        Text(text = "Course: ${student.course}", fontSize = 14.sp)
        Text(text = "Teacher: ${student.teacher}", fontSize = 14.sp)
    }
}
